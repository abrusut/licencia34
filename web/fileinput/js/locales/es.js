...
(function ($) {
    ...
    $.fn.fileinputLocales['es'] = {
        ...
        msgDuplicateFile: 'El Archivo "{name}" de tamaño "{size} KB" ya ha sido seleccionado para su subida. No se agrega para evitar duplicacion.',
        msgResumableUploadRetriesExceeded:  'Upload cancelado <b>{max}</b> reintentos para el archivo <b>{file}</b>! Error Detalles: <pre>{error}</pre>',
        msgPendingTime: '{time} restante',
        msgCalculatingTime: 'calculando tiempo demora',
        ajaxOperations: {
